    ...
    function timerCallback() {
      ...
      healthCheck()
        .then(() => {
          ...
          circuitOpen = false;
          trap.emit("close");
        }, err => console.error("unhealthy", err));
    }

    const trap = Object.create(EventEmitter.prototype, {
      "exec": {
        value(...args) {
      ...
      "setHealthCheck": {
        value(hcArg1, hcArg2, hcArg3) {
          ...
          if (typeof hcArg1 === "function") {
            ...
            healthCheck = healthCheck.bind(hcArg1);
            interval = hcArg3;
          } else {
